...
@section('content')
    <div class="max-w-4xl mx-auto p-6">
        ...
        <form method="POST" action="{{ route('manage.raid.update', $raid->raid_id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-sm mt-2">
                        ...
                        <a href="{{ route('manage.club.edit', $raid->club_id) }}" class="underline text-brand-green">Adhérents du club</a>
                    </p>
                </div>
