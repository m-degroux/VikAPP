                        ...
                        <div class="form-section-container">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                @foreach ($ageCategories as $cat)
                                    <div
                                        class="js-age-card bg-gray-50 p-4 rounded-lg border border-gray-200 flex flex-col justify-between">
                                        ...
                                        <div class="relative">
                                            <input type="number" step="0.01" name="prices[{{ $cat->age_id }}]"
                                                ...
                                                class="js-price-input form-input pr-8 bg-gray-200"
                                                placeholder="Prix en €" disabled>
                                            <div
                                                class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">€</span>
                                            </div>
