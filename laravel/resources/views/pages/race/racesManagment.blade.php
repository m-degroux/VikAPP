...
@section('content')
    ...
    @include('partials.herosection', ['pageTitle' => 'Gestion des courses', 'pageSubTitle' => 'Administrez et supervisez vos événements de course avec efficacité.', 'imageUrl' => asset('img/heroSection/header.jpg')])
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            ...
            @foreach($races as $race)
                ...
                <div class="card-event flex flex-col relative">
                    ...
                    <a href="{{ url('/manage/race/'.$race->race_id) }}"
                       class="btn-primary w-full text-center">
                        Manager
                    </a>

                    {{-- Action buttons section --}}
                    <a href="{{ url('/race/'.$race->race_id.'/info') }}"
