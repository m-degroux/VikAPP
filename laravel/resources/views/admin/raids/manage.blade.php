                ...
                <tbody>
                    ...
                    @forelse($raids as $raid)
                        <tr>
                            ...
                            <td class="text-right">
                                <!-- Bouton Modifier -->
                                <a href="{{ route('manage.raids.edit', $raid->raid_id ?? $r->raid_id) }}" class="btn btn-sm btn-primary" title="Modifier">
                                    Modifier
                                </a>
                                {{-- Navigation link to add a new race (épreuve) to this specific raid --}}
                                <a href="{{ route('races.create', ['raid_id' => $raid->raid_id]) }}" class="btn-table-action">
                                    Ajouter une course
                                </a>
                            </td>
